...
from benchmarks_2.cegis_round import Cegis
from utils.Config_B import CegisConfig
import timeit
import torch
import numpy as np
from benchmarks_2.Exampler_B import get_example_by_name, get_example_by_id
...
def main():
    ...
    example = get_example_by_name('sharpe2')
    ...
    opts = {
        ...
        "DEG": [0, 2, 2, 1],  # Respectively represent the times of init, unsafe, diffB,
