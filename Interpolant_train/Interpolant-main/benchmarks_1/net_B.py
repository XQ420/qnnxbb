...
class Net(nn.Module):
    def __init__(self, config: CegisConfig):
        ...
        for n_hid, act in zip(hiddens, activate):
            ...
            if act not in ['SKIP']:
                ...
                layer2 = nn.Linear(input_size, n_hid, bias=self.skip_bias)
    ...
    def forward(self, x):
        ...
        return numerical_b, None, None, None
